...
export const factionsMock: Faction[] = [
  ...
  {
    description: 'Nanomachines are the protons of the futile mind.',
    id: 2,
    image: 'https://picsum.photos/200/300',
    name: 'Adeptus Astartes',
  },
  {
    description: 'Cosmonauts are the nanomachines of the boldly rumour.',
    id: 3,
    image: 'https://picsum.photos/200/300',
    name: 'Adeptus Mechanicus',
  },
  {
    description: 'Conscious metamorphosis lead to the courage.',
    id: 4,
    image: 'https://picsum.photos/200/300',
    name: 'Orks',
  },
